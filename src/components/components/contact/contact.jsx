        ...
        return (
            ...
            <div className="contact">
                ...
                <TextField hintText="Your message" floatingLabelText="Your message" style={{
                    ...
                    "borderColor": "#A80202"
                }} onChange={e => this.onUpdateField('message', e)}/> {this.state.errorMessage != null &&
            <p className="error-message message">{this.state.errorMessage}</p>
                ...
                <div className="contact-btn">
                    <RaisedButton label="Send message" onClick={this.onSubmit.bind(this)} backgroundColor="#A80202"
                                  labelColor="#ffffff"/>
                </div>
            </div>
        );
